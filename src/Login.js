...
const HomePage = () => {
  ...
  return (
  	<div className="flex min-h-screen items-center justify-center">
  		...
  		<div className="grid grid-col-1 gap-4 max-w-md w-full shadow py-10 px-12 rounded-lg">
	  		<H2 className="mb-3">Sign In</H2>
	  		{errors.signin && <Alert type="danger" message={errors.signin}/>}
	  		<Labelled.Input ref={register} name="email" type="text" label="Email Address" fullwidth
	  			onBlur={() => {}} />
	  		<Labelled.Input ref={register} name="password" type="password" label="Password" fullwidth 
	  			onBlur={() => {}} />
	  		<div className="mt-5">
